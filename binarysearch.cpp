//
// Created by Lenovo on 27/01/2024.
//
#include <iostream>
#include <vector>
#include <iomanip>
...
int binary_search(const std::vector<int>& a, int seek){
    int first = 0, // Initially the first position
        last = static_cast<int>(a.size()) - 1, // Initially the last position
 ...
 * a is the vector. value is the element to locate.
 */
...
int main(){
    ...
    // an empty vector
    std::vector<int> even_list{1,2,3,4,6,7,8},
